...
const AddCustomerScreen = () => {
  ...
  return (
    <BaseLayout style={styles.container}>
      <Header
              title={contents.addcustom.title}
              showBackIcon={true}
            ...
            <View style={styles.card}>
             <DynamicText >{contents.addcustom.show}</DynamicText>
      <View style={styles.avatarContainer}>
  <Image source={Images.SHOP} style={{ width: scaleWidth(50), height: scaleHeight(50), borderRadius: 50 }} />
</View>
      
     
        <Text style={styles.label}>{contents.addcustom.text}</Text>
        {/* Họ và tên */}
        <View style={styles.inputContainer}>
          <Controller
            control={control}
            name="fullName"
            rules={{ required: contents.addcustom.username_required, pattern: { value: RegexPatterns.USERNAME, message:contents.addcustom.username_length } }}
            render={({ field: { onChange, value } }) => (
              <Input placeholderText={contents.addcustom.username} onChangeText={onChange} value={value} />
            )}
          />
            ...
            render={({ field: { onChange, value } }) => (
              <View style={styles.pickerContainer}>
                <Picker selectedValue={value} onValueChange={onChange} style={styles.picker}>
                  <Picker.Item label={contents.addcustom.gender} value="" />
        ...
        <View style={styles.inputContainer}>
          <Controller
            control={control}
            name="phone"
            rules={{ required: contents.addcustom.phone_required, pattern: { value: RegexPatterns.PHONE_NUMBER, message: contents.addcustom.phone_length } }}
            render={({ field: { onChange, value } }) => (
              <Input placeholderText={contents.addcustom.phone} keyboardType="phone-pad" onChangeText={onChange} value={value} />
            )}
          />
        ...
        <View style={styles.inputContainer}>
          <Controller
            control={control}
            name="email"
            rules={{ required: contents.addcustom.email_required, pattern: { value: RegexPatterns.EMAIL, message: contents.addstaff.email_length } }}
            render={({ field: { onChange, value } }) => (
              <Input placeholderText={contents.addcustom.email} keyboardType="email-address" onChangeText={onChange} value={value} />
            )}
          />
        ...
        <View style={styles.inputContainer}>
          <Controller
            control={control}
            name="birthDate"
            rules={{ required: contents.addcustom.day_required }}
            render={({ field: { onChange, value } }) => (
              <Input placeholderText={contents.addcustom.day} onChangeText={onChange} value={value} />
            )}
          />
        ...
        <View style={styles.inputContainer}>
          <Controller
            control={control}
            name="address"
            rules={{ required: contents.addcustom.adress_required }}
            render={({ field: { onChange, value } }) => (
              <Input placeholderText={contents.addcustom.address} onChangeText={onChange} value={value} />
            )}
          />
