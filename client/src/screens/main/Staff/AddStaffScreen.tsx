    ...
    <BaseLayout style={styles.container}>
      <Header
            ...
            <View style={styles.card}>
             <DynamicText >{contents.addstaff.show}</DynamicText>
      <View style={styles.avatarContainer}>
  <Image source={Images.SHOP} style={{ width: scaleWidth(50), height: scaleHeight(50), borderRadius: 50 }} />
</View>
      
     
        <Text style={styles.label}>{contents.addstaff.text}</Text>
        ...
        <View style={styles.inputContainer}>
          <Controller
            control={control}
            name="employeeId"
            rules={{ required: contents.addstaff.id_required }}
            render={({ field: { onChange, value } }) => (
              <Input placeholderText={contents.addstaff.id_staff} onChangeText={onChange} value={value} />
            )}
          />
        ...
        <View style={styles.inputContainer}>
          <Controller
            control={control}
            name="fullName"
            rules={{ required: contents.addstaff.username_required, pattern: { value: RegexPatterns.USERNAME, message:contents.addstaff.username_length } }}
            render={({ field: { onChange, value } }) => (
            ...
            render={({ field: { onChange, value } }) => (
              <View style={styles.pickerContainer}>
                <Picker selectedValue={value} onValueChange={onChange} style={styles.picker}>
                  <Picker.Item label={contents.addstaff.gender} value="" />
        ...
        <View style={styles.inputContainer}>
          <Controller
            control={control}
            name="phone"
            rules={{ required: contents.addstaff.phone_required, pattern: { value: RegexPatterns.PHONE_NUMBER, message: contents.addstaff.phone_length } }}
            render={({ field: { onChange, value } }) => (
              <Input placeholderText={contents.addstaff.phone} keyboardType="phone-pad" onChangeText={onChange} value={value} />
            )}
          />
        ...
        <View style={styles.inputContainer}>
          <Controller
            control={control}
            name="email"
            rules={{ required: contents.addstaff.email_required, pattern: { value: RegexPatterns.EMAIL, message: contents.addstaff.email_length } }}
            render={({ field: { onChange, value } }) => (
              <Input placeholderText={contents.addstaff.email} keyboardType="email-address" onChangeText={onChange} value={value} />
            )}
          />
        ...
        <View style={styles.inputContainer}>
          <Controller
            control={control}
            name="birthDate"
            rules={{ required: contents.addstaff.day_required }}
            render={({ field: { onChange, value } }) => (
              <Input placeholderText={contents.addstaff.day} onChangeText={onChange} value={value} />
            )}
          />
        ...
        <View style={styles.inputContainer}>
          <Controller
            control={control}
            name="address"
            rules={{ required: contents.addstaff.adress_required }}
            render={({ field: { onChange, value } }) => (
              <Input placeholderText={contents.addstaff.address} onChangeText={onChange} value={value} />
            )}
          />
        ...
        <View style={styles.inputContainer}>
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              <View style={styles.pickerContainer}>
                <Picker selectedValue={value} onValueChange={onChange} style={styles.picker}>
                  <Picker.Item label={contents.addstaff.position} value="" />
...
<Button
          title={contents.addstaff.button_title}
