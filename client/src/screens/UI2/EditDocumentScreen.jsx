...
const AddSupplierScreen = () => {
  ...
  return (
    <BaseLayout style={styles.container}>
      <Header
        title={contents.addsupplier?.title || 'Thêm nhà cung cấp'} // Sử dụng optional chaining và giá trị mặc định
        showBackIcon={true}
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.card}>
          <Text style={styles.label}>{contents.addsupplier?.show || 'SửaSửa nhà cung cấp'}</Text>
          ...
          <View style={styles.inputContainer}>
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <Input placeholderText={contents.addsupplier?.id_supplier || 'Mã nhà cung cấp'} onChangeText={onChange} value={value} />
              )}
            />
          ...
          <View style={styles.inputContainer}>
            <Controller
              control={control}
              name="name"
              rules={{ required: contents.addsupplier?.name_required || 'Tên nhà cung cấp là bắt buộc', pattern: { value: RegexPatterns.USERNAME, message: contents.addsupplier?.name_length || 'Tên không hợp lệ' } }}
              render={({ field: { onChange, value } }) => (
                <Input placeholderText={contents.addsupplier?.name || 'Tên nhà cung cấp'} onChangeText={onChange} value={value} />
              )}
            />
          ...
          <View style={styles.inputContainer}>
            <Controller
              control={control}
              name="phone_number"
              rules={{ required: contents.addsupplier?.phone_required || 'Số điện thoại là bắt buộc', pattern: { value: RegexPatterns.PHONE_NUMBER, message: contents.addsupplier?.phone_length || 'Số điện thoại không hợp lệ' } }}
              render={({ field: { onChange, value } }) => (
                <Input placeholderText={contents.addsupplier?.phone || 'Số điện thoại'} keyboardType="phone-pad" onChangeText={onChange} value={value} />
              )}
            />
          ...
          <View style={styles.inputContainer}>
            <Controller
              control={control}
              name="email"
              rules={{ required: contents.addsupplier?.email_required || 'Email là bắt buộc', pattern: { value: RegexPatterns.EMAIL, message: contents.addsupplier?.email_length || 'Email không hợp lệ' } }}
              render={({ field: { onChange, value } }) => (
                <Input placeholderText={contents.addsupplier?.email || 'Email'} keyboardType="email-address" onChangeText={onChange} value={value} />
              )}
            />
          ...
          <View style={styles.inputContainer}>
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <Input placeholderText={contents.addsupplier?.address || 'Địa chỉ'} onChangeText={onChange} value={value} />
              )}
            />
