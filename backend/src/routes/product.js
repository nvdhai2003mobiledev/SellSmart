...
router.put("/variants/details/:detailId", productController.updateVariantDetail);
...
router.get("/getdetailsvariant", detailsVariantController.getAllDetailsVariants); // Lấy tất cả DetailsVariant
router.get("/getdetailsvariant/:variantId", detailsVariantController.getDetailsByVariant); // Lấy theo variantId
router.post("/getdetailsvariant/create", detailsVariantController.addDetailsVariant); // Thêm mới
router.delete("/getdetailsvariant/delete/:detailsVariantId", detailsVariantController.deleteDetailsVariant); // Xóa
